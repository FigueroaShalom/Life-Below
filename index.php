...
?>
    ...
    <script>
        ...
        (function() {
            ...
            function fetchNews() {
                if (!API_KEY || API_KEY === 'd5b5320a0accff00272ab27733ba94ce') {
                    track.innerHTML = '<div class="loading-placeholder"></div>';
                    return;
                }
...
<?php 
    ...
    if (file_exists($section_file)) {
        ...
        echo '<div class="hy-section" style="max-width:1300px;margin:0 auto;padding:4rem 2rem;"><h1 style="font-size:2rem;color:#0a2b3b;">🌊 Sección en construcción</h1><p style="color:#1b4e60;">Pronto más contenido sobre conservación marina.</p></div>';
    }
}
