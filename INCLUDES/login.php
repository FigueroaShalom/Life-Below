...
<style>
    ...
    .os-input-wrap:focus-within svg {
        color: #00d4e8;
    }
        ...
        <div class="os-brand">
            ...
            <div class="os-turtle">
                <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ellipse cx="42" cy="40" rx="10" ry="6" fill="rgba(255,255,255,0.1)"
                    ...
                    <ellipse cx="47" cy="20" rx="4" ry="3" fill="rgba(255,255,255,0.14)"
                        transform="rotate(-10,47,20)" />
                    <g class="t-eye">
                    ...
                    <path d="M45 29 Q50 33 55 29" stroke="#094d2a" stroke-width="1.3" fill="none"
